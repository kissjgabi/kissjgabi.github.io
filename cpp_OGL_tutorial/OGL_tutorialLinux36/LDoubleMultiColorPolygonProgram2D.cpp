...
bool LDoubleMultiColorPolygonProgram2D::loadProgram()
{
	...
	//Load vertex shader
	GLuint vertexShader = loadShaderFromFile( "LDoubleMultiColorPolygonProgram2D.glvs", GL_VERTEX_SHADER );
	...
	GLuint fragmentShader = loadShaderFromFile( "LDoubleMultiColorPolygonProgram2D.glfs", GL_FRAGMENT_SHADER );
