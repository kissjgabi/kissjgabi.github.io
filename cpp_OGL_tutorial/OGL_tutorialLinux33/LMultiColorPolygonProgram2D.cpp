...
bool LMultiColorPolygonProgram2D::loadProgram()
{
	...
	//Load vertex shader
	GLuint vertexShader = loadShaderFromFile( "LMultiColorPolygonProgram2D.glvs", GL_VERTEX_SHADER );
	...
	GLuint fragmentShader = loadShaderFromFile( "LMultiColorPolygonProgram2D.glfs", GL_FRAGMENT_SHADER );
